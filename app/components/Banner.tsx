...
function Banner() {
  return (
    <>
      <section className='relative w-full max-w-[1920px] bg-banner bg-cover bg-no-repeat pt-[34px] text-center lg:flex lg:h-[440px] lg:items-center lg:overflow-hidden lg:pt-0 2xl:h-[586px]'>
        ...
        />
        <Image
          className='!left-auto !right-0 !top-0 hidden lg:block lg:!h-[480px] lg:!w-[900px] 2xl:!h-[586px] 2xl:!w-[1100px]'
